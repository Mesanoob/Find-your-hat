...
const _WIDTHPROMPT =
  'Enter the no. of tiles for the WIDTH (min. 5 - max. 100): '
const _HEIGHTPROMPT =
  'Enter the no. of tiles for the HEIGHT (min. 5 - max. 100): '
...
const createdField = Field.createField(
  Number(gameDimensions.width),
  Number(gameDimensions.height)
)
